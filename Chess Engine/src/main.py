...
class Main:
    ...
    def ai_turn(self, screen, game, board):
        ai_move = self.ai.choose_move(board)

        if ai_move is None:
            pygame.display.set_caption('Chess - AI has no legal moves')
            return
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                # click release
                    ...
                    if human_moved and game.next_player == self.ai.color:
                        pygame.time.delay(300)
                        self.ai_turn(screen, game, board)
